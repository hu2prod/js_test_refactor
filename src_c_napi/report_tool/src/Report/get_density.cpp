...
napi_value Report_get_density_sync(napi_env env, napi_callback_info info) {
  ...
  i64 ret;
  _Report_get_density_impl(err, _this, idx, ret);
  if (err) {
...
//   async
////////////////////////////////////////////////////////////////////////////////////////////////////
struct Worker_ctx_Report_get_density {
  Report* _this;
  u64 idx;
  i64 ret;
...
void _worker_ctx_Report_get_density_clear(napi_env env, struct Worker_ctx_Report_get_density* worker_ctx) {
  if (worker_ctx->err) {
...
void _execute_Report_get_density(napi_env env, void* _data) {
  struct Worker_ctx_Report_get_density* worker_ctx = (struct Worker_ctx_Report_get_density*)_data;
  _Report_get_density_impl(worker_ctx->err, worker_ctx->_this, worker_ctx->idx, worker_ctx->ret);
}

void _complete_Report_get_density(napi_env env, napi_status execute_status, void* _data) {
  napi_status status;
  struct Worker_ctx_Report_get_density* worker_ctx = (struct Worker_ctx_Report_get_density*)_data;
  ...
  if (status != napi_ok) {
    ...
    _worker_ctx_Report_get_density_clear(env, worker_ctx);
    return;
  }
...
napi_value Report_get_density(napi_env env, napi_callback_info info) {
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  Worker_ctx_Report_get_density* worker_ctx = new Worker_ctx_Report_get_density;
  worker_ctx->err = nullptr;
  ...
  status = napi_create_async_work(
    ...
    nullptr,
    async_resource_name,
    _execute_Report_get_density,
    _complete_Report_get_density,
    (void*)worker_ctx,
    &worker_ctx->work
  );
  if (status != napi_ok) {

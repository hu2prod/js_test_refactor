...
napi_value Report_sort_by_density_percent_desc_sync(napi_env env, napi_callback_info info) {
  ...
  _Report_sort_by_density_percent_desc_impl(err, _this);
  if (err) {
...
//   async
////////////////////////////////////////////////////////////////////////////////////////////////////
struct Worker_ctx_Report_sort_by_density_percent_desc {
  Report* _this;
...
void _worker_ctx_Report_sort_by_density_percent_desc_clear(napi_env env, struct Worker_ctx_Report_sort_by_density_percent_desc* worker_ctx) {
  if (worker_ctx->err) {
...
void _execute_Report_sort_by_density_percent_desc(napi_env env, void* _data) {
  struct Worker_ctx_Report_sort_by_density_percent_desc* worker_ctx = (struct Worker_ctx_Report_sort_by_density_percent_desc*)_data;
  _Report_sort_by_density_percent_desc_impl(worker_ctx->err, worker_ctx->_this);
}

void _complete_Report_sort_by_density_percent_desc(napi_env env, napi_status execute_status, void* _data) {
  napi_status status;
  struct Worker_ctx_Report_sort_by_density_percent_desc* worker_ctx = (struct Worker_ctx_Report_sort_by_density_percent_desc*)_data;
  ...
  if (status != napi_ok) {
    ...
    _worker_ctx_Report_sort_by_density_percent_desc_clear(env, worker_ctx);
    return;
  }
...
napi_value Report_sort_by_density_percent_desc(napi_env env, napi_callback_info info) {
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  Worker_ctx_Report_sort_by_density_percent_desc* worker_ctx = new Worker_ctx_Report_sort_by_density_percent_desc;
  worker_ctx->err = nullptr;
  ...
  status = napi_create_async_work(
    ...
    nullptr,
    async_resource_name,
    _execute_Report_sort_by_density_percent_desc,
    _complete_Report_sort_by_density_percent_desc,
    (void*)worker_ctx,
    &worker_ctx->work
  );
  if (status != napi_ok) {

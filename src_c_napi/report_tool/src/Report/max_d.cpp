...
napi_value Report_max_d_sync(napi_env env, napi_callback_info info) {
  ...
  i64 ret;
  _Report_max_d_impl(err, _this, ret);
  if (err) {
...
//   async
////////////////////////////////////////////////////////////////////////////////////////////////////
struct Worker_ctx_Report_max_d {
  Report* _this;
  i64 ret;
...
void _worker_ctx_Report_max_d_clear(napi_env env, struct Worker_ctx_Report_max_d* worker_ctx) {
  if (worker_ctx->err) {
...
void _execute_Report_max_d(napi_env env, void* _data) {
  struct Worker_ctx_Report_max_d* worker_ctx = (struct Worker_ctx_Report_max_d*)_data;
  _Report_max_d_impl(worker_ctx->err, worker_ctx->_this, worker_ctx->ret);
}

void _complete_Report_max_d(napi_env env, napi_status execute_status, void* _data) {
  napi_status status;
  struct Worker_ctx_Report_max_d* worker_ctx = (struct Worker_ctx_Report_max_d*)_data;
  ...
  if (status != napi_ok) {
    ...
    _worker_ctx_Report_max_d_clear(env, worker_ctx);
    return;
  }
...
napi_value Report_max_d(napi_env env, napi_callback_info info) {
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////
  Worker_ctx_Report_max_d* worker_ctx = new Worker_ctx_Report_max_d;
  worker_ctx->err = nullptr;
  ...
  status = napi_create_async_work(
    ...
    nullptr,
    async_resource_name,
    _execute_Report_max_d,
    _complete_Report_max_d,
    (void*)worker_ctx,
    &worker_ctx->work
  );
  if (status != napi_ok) {
